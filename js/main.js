Performtack();
let insertTaskInput= document.getElementById("addtaskinput");
let addtaskbtn = document.getElementById("addtaskbtn");

addtaskbtn.addEventListener("click", function(){
    addtaskinputval = insertTaskInput.value;
...
let a;
    ...
    fun=()=>{
        a=new Date();
        date=a.toDateString();
        let b=date.indexOf("2");
        date=date.substring(0,b-1)+", "+date.substring(b);
        time=Hun()+':'+mun()+':'+sun();
...
function edittask(index){
    ...
    insertTaskInput.value = taskObj[index]['task_name'];
...
savetaskbtn.addEventListener("click", function(){
    ...
    for (keys in taskObj[saveindex]) {
        if(keys == 'task_name'){
            taskObj[saveindex].task_name = insertTaskInput.value;
        }
      }
    // taskObj[saveindex] = {'task_name':insertTaskInput.value, 'completeStatus':false} ;
  //  taskObj[saveindex][task_name] = insertTaskInput.value;
